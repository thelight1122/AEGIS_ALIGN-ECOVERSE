    ...
    <div class="layout">
      <header class="topbar">
        <div class="topbar-inner">
          <a class="brand" href="/">
            <span class="brand-pill" style="background: #BA68C8;"></span>
      ...
      <div class="ethos-strip" style="background: rgba(142, 36, 170, 0.05); border-bottom: 1px solid rgba(142, 36, 170, 0.1);">
      ...
      <div class="shell">
        ...
        <main class="panel content-wrap">
          <div class="content-head">
            <div>
              <h1 style="color: #BA68C8;">${pageTitle}</h1>
              <div class="breadcrumb">Peer Workspace / ${slug}</div>
            </div>
          </div>
          
          <div class="iframe-wrap" style="height: calc(100vh - 180px);">
            <iframe class="stitch-frame" data-frame-role="active" title="${pageTitle}" src="/stitch/peer-profile/${slug}/" style="border:none; width:100%; height:100%;" loading="lazy"></iframe>
          </div>
        </main>
      </div>
    </div>
