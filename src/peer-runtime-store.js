...
function buildPeerRecord(draftAgent = {}) {
  ...
  return {
    ...
    boundedShellAccess: {
      status: "provisioned",
      originNode: "192.168.1.223",
      shellType: "rbash",
      keyId: "adam-one_ed25519",
      keyFingerprint: "SHA256:wGlEVJuCrph9rj+bjM5d0+5KGPzzWTzvG/UsMS9J65I",
      sessionLogging: "script-audit",
      allowedActions: [
        "git", "nano", "vim", "less", "cat", "grep", "find", "tree",
        "make", "python3", "pip3",
        "ecoverse-build", "ecoverse-repair",
        "systemctl-reload-ecoverse", "systemctl-status-ecoverse",
      ],
      sudoScope: ["ecoverse-build", "ecoverse-repair", "systemctl-reload", "systemctl-status"],
      forbiddenActions: ["path_override", "absolute_exec", "tcp_forwarding", "x11_forwarding", "tunnel"],
      embodymentLayer: "distinct-presence",
      infraRef: "infrastructure/ecoverse-bounded-env/",
      docRef: "docs/adam-one-bounded-shell-environment.md",
      aegisPrinciples: ["illuminate-not-compel", "observe-not-punish", "repair-over-restriction"],
      provisionedAt: "2026-05-23",
    },
